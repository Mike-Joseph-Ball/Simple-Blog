...
import DarkModeLogo from '@/app/images/Dark-Mode-Logo.svg'
const font = Poppins({
    subsets: ['latin'],
    weight: ["400", "600"]
})
...
const Logo = () => {
    ...
    <div className=" hidden md:flex items-center gap-x-2">
        <Image src={LightModeLogo} height={40} width={40} alt="logo" className="dark:hidden" />
        <Image src={DarkModeLogo} height={40} width={40} alt="logo" className="hidden dark:block" />
